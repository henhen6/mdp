...
public class DashboardLoginController {
    ...
    @RequestLog(value = "查询登录概览", response = false)
    ...
    @RequestLog(value = "查询登录地域分布", response = false)
    ...
    @RequestLog(value = "查询登录省份排行", response = false)
    ...
    @RequestLog(value = "查询登录IP排行", response = false)
    ...
    @RequestLog(value = "查询姓名登录排行", response = false)
    ...
    @RequestLog(value = "查询浏览器分布", response = false)
    ...
    @RequestLog(value = "查询操作系统分布", response = false)
    ...
    @RequestLog(value = "查询登录方式分布", response = false)
    ...
    @RequestLog(value = "查询登录渠道分布", response = false)
    ...
    @RequestLog(value = "查询事件类型分布", response = false)
    ...
    @RequestLog(value = "查询每日登录统计", response = false)
    ...
    @RequestLog(value = "查询活跃用户排行", response = false)
    ...
    @RequestLog(value = "查询登录时段分布", response = false)
