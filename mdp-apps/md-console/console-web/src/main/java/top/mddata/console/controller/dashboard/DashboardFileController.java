...
public class DashboardFileController {
    ...
    @RequestLog(value = "查询文件存储概览", logType = RequestLog.LogType.QUERY, response = false)
    ...
    @RequestLog(value = "查询文件类型分布", logType = RequestLog.LogType.QUERY, response = false)
    ...
    @RequestLog(value = "查询业务类型分布", logType = RequestLog.LogType.QUERY, response = false)
    ...
    @RequestLog(value = "查询存储平台分布", logType = RequestLog.LogType.QUERY, response = false)
    ...
    @RequestLog(value = "查询文件大小分布", logType = RequestLog.LogType.QUERY, response = false)
