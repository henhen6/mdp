...
import top.mddata.console.organization.dto.OrgNatureDto;
import top.mddata.console.organization.query.OrgNatureQuery;
import top.mddata.console.organization.service.OrgNatureService;
import top.mddata.console.organization.vo.OrgNatureVo;
...
public class OrgNatureController extends SuperController<OrgNatureService, OrgNature> {
     ...
     */
    @PostMapping("/page")
    @Operation(summary = "分页列表查询", description = "分页查询组织性质")
    @RequestLog(value = "'分页列表查询:第' + #params?.current + '页, 显示' + #params?.size + '行'", response = false)
    public R<Page<OrgNatureVo>> page(@RequestBody @Validated PageParams<OrgNatureQuery> params) {
        Page<OrgNatureVo> page = Page.of(params.getCurrent(), params.getSize());
        OrgNature entity = BeanUtil.toBean(params.getModel(), OrgNature.class);
