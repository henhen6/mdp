...
import top.mddata.open.dto.AppApplyDto;
import top.mddata.open.entity.AppApply;
import top.mddata.open.query.AppApplyQuery;
import top.mddata.open.service.AppApplyService;
import top.mddata.open.vo.AppApplyVo;
...
public class AppApplyController extends SuperController<AppApplyService, AppApply> {
    ...
    public R<List<AppApplyVo>> list(@RequestBody @Validated AppApplyQuery params) {
        AppApply entity = BeanUtil.toBean(params, AppApply.class);
        QueryWrapper wrapper = QueryWrapper.create(entity, WrapperUtil.buildOperators(entity.getClass()));
        List<AppApplyVo> listVo = superService.listAs(wrapper, AppApplyVo.class);
